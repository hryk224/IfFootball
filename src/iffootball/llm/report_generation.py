...
_CODE_GENERATED_SECTIONS = frozenset({
    "what_to_watch", "hypothesis_review", "next_steps",
})
...
def _append_code_sections(
    ...
    order = section_order or _DEFAULT_SECTION_ORDER
    # Append code-generated sections only if included in section_order
    # (or always when section_order is None, for backward compatibility).
